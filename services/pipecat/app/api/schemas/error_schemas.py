...
class ErrorObject(BaseModel):
    ...
    details: Optional[List[ErrorDetail]] = Field(
        None, description="List of specific error details (e.g., validation failures)."
    )
...
class APIErrorResponse(BaseModel):
    ...
    error: ErrorObject
    links: Optional[Dict[str, ErrorLink]] = Field(
        None, alias="_links", description="Navigation links related to the error."
    )
