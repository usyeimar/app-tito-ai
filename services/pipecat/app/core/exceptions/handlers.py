...
from app.api.schemas.error_schemas import APIErrorResponse, ErrorDetail, ErrorObject, ErrorSource
...
def register_exception_handlers(app: Any):
    ...
    async def validation_exception_handler(request: Request, exc: RequestValidationError):
        ...
        return JSONResponse(
            status_code=422, content=response.model_dump(by_alias=True, exclude_none=True)
        )
