...
/**
* @see \App\Http\Controllers\Central\Web\Tenancy\TenantController::index
* @see app/Http/Controllers/Central/Web/Tenancy/TenantController.php:22
...
const TenantController = { index, store, enter }
